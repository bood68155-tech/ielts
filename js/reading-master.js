  ...
  function render() {
    ...
    $('#readmaster-content').innerHTML = `
      <div class="bg-[rgba(15,23,42,0.85)] backdrop-blur-md border border-[rgba(212,175,55,0.25)] rounded-2xl p-6 mb-6">
        <h2 class="text-2xl font-extrabold text-[#f5f0e6]"><span data-imi-icon="read" data-imi-size="w-6 h-6" class="imi-icon-head"></span>Reading Master Suite</h2>
      ...
      <div class="flex flex-wrap items-center justify-between gap-3 bg-gradient-to-r from-[rgba(124,58,237,0.28)] to-[rgba(217,70,239,0.18)] border border-[rgba(167,139,250,0.45)] rounded-2xl p-5 mb-6">
        ...
        <div class="flex gap-2 flex-wrap">
          <button class="px-4 py-2 rounded-lg text-sm font-bold text-[#14120f] bg-[#d4af37] hover:bg-[#b8962e] transition" onclick="window.IELTS_AI.openPassageModal()"><span data-imi-icon="spark" data-imi-size="w-4 h-4" class="inline-block -mt-0.5 mr-1"></span>Build a passage</button>
          <button class="px-4 py-2 rounded-lg text-sm font-bold text-[#f5f0e6] border border-[rgba(167,139,250,0.5)] hover:bg-[rgba(167,139,250,0.12)] transition" onclick="window.IELTS_AI.openLibraryModal('passage')"><span data-imi-icon="library" data-imi-size="w-4 h-4" class="inline-block -mt-0.5 mr-1"></span>My AI passages (${aiPassageCount})</button>
        </div>
      </div>
