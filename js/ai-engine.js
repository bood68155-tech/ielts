...
(function () {
  ...
  /* Teacher Rami's official avatar — assets/teacher-rami.jpg (final pixel-art kuffiyeh portrait). */
  const MENTOR_AVATAR = '<img class="rami-avatar" src="assets/teacher-rami.jpg" alt="Teacher Rami (الأستاذ رامي)" loading="lazy" decoding="async" />';
